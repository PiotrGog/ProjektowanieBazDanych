...
public class GameDataGenerator {
    ...
    /**
     * Finds data base by its name and fills data base with prepared data.
     * @param databaseName name to find data base
     */
...
//        }
    ...
    /**
     * Creates random Player object with given name.
     * @param name name of new player
     * @return new randomly generated player
     */
