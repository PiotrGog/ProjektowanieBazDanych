...
for x in range(5000):
    characters.append(Characters(Name =random.choice(NAMES_CHAR) +  str(randint(1,2939945)),
                                 ...
                                 IdField = randint(1, 15000),
                                 IdRace = randint(12, 101),
                                 IdTeam = randint(125, 203) ))
session.add_all(characters)
session.commit()
action_char = []
for x in range(25000):
    action_char.append(CharacterAction(IdCharacter = randint(8000,36000),IdAction = randint(1,41)))
session.add_all(action_char)
session.commit()
buff_char = []
for x in range(25000):
    buff_char.append(CharacterBuff(IdCharacter = randint(8000,36000),IdBuff = randint(1,32)))
...
quests = []
for x in range(25000):
    quests.append(Quests(IdCharacter = randint(8000,36000),QuestDescription = random.choice(QUEST_DESCRIPTION)))
session.add_all(quests)
session.commit()
quest_act = []
for x in range(50000):
    quest_act.append(Quest_Action(IdAction = randint(1,41),IdQuest = randint(1,25000)))
session.add_all(quest_act)
session.commit
race_cla = []
for x in range(300):
    race_cla.append(RaceClass(IdRace = randint(12,101),IdClass = randint(1,6)))
...
act_skill = []
for x in range(3000):
    act_skill.append(ActionSkill(IdAction = randint(1,41),IdSkill = randint(79,155)))
session.add_all(act_skill)
session.commit()
char_quest = []
for x in range(30000):
    char_quest.append(CharacterQuest(IdCharacter = randint(8000,36000),IdQuest = randint(1,25000)))
session.add_all(char_quest)
session.commit()

char_spec = []
for x in range(30000):
    char_spec.append(CharacterSpecialization(IdCharacter = randint(8000,36000),IdSpec = randint(1,60)))
...
for x in range(60000):
    round_act.append(RoundAction(IdRound = randint(1,30000),IdAction = randint(1,41)))
...
for x in range(10000):
    treasure_ques.append(TreasureQuest(IdQuest = randint(1,25000),IdTreasure = randint(1,3000)))
session.add_all(treasure_ques)
session.commit()

treasure_fiel = []
for x in range(10000):
    treasure_fiel.append(TreasureField(IdField = randint(1,15000),IdTreasure = randint(1,3000)))
session.add_all(treasure_fiel)
session.commit()

roll_skill = []
for x in range(10000):
    roll_skill.append(RollSkill(IdRoll = randint(1,1000),IdSkill = randint(79,155)))
...
eq_mod = []
for x in range(10000):
    eq_mod.append(EquipmentModifer(IdMod = randint(107,142),IdEquipm= randint(107,253)))
session.add_all(eq_mod)
session.commit()
eq_char = []
for x in range(10000):
    eq_char.append(CharacterEquipment(IdCharacter = randint(8000,36000),IdEquipm= randint(107,253), Amount= randint(0,3)))
session.add_all(eq_char)
session.commit()

eq_tres = []
for x in range(10000):
    eq_tres.append(TreasureEquipment(IdTreasure = randint(1,3000),IdEquipm= randint(107,253)))
session.add_all(eq_tres)
session.commit()

spec_skill = []
for x in range(30000):
    spec_skill.append(SpecializationSkill(IdSpec = randint(1,60),IdSkill= randint(79,155)))
session.add_all(spec_skill)
session.commit()

char_zone = []
for x in range(1000):
    char_zone.append(CharacterZone(IdCharacter = randint(8000,36000),IdZone = randint(1,9), IdEquipm=  randint(107,253)))
    session.add_all(char_zone)
session.commit()

equ_zone = []
for x in range(1000):
    equ_zone.append(EquipmentZone(IdEquipm=  randint(107,253),IdZone= randint(1,9)))
    print(x)
