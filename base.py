...
for x in range(20000):
    mod_buff.append(BuffModifier(ModifierValue = randint(-8,9),IdMod = random.choice(mod_ids), IdBuff = random.choice(buffs_ids)))
...
for x in range(25000):
    action_char.append(CharacterAction(IdCharacter = random.choice(characters_ids), IdAction = random.choice(actions_ids)))
...
buff_char = []
for x in range(25000):
    buff_char.append(CharacterBuff(IdCharacter = random.choice(characters_ids),IdBuff = random.choice(buffs_ids)))
...
race_cla = []
for x in range(300):
    race_cla.append(RaceClass(IdRace = random.choice(races_ids),IdClass = randint(1,6)))
...
act_skill = []
for x in range(3000):
    act_skill.append(ActionSkill(IdAction = random.choice(actions_ids),IdSkill = random.choice(skills_ids)))
...
for x in range(30000):
    char_quest.append(CharacterQuest(IdCharacter = random.choice(characters_ids),IdQuest = random.choice(quests_ids)))
...
char_spec = []
for x in range(30000):
    char_spec.append(CharacterSpecialization(IdCharacter = random.choice(characters_ids),IdSpec = random.choice(specs_ids)))
...
for x in range(60000):
    round_act.append(RoundAction(IdRound = random.choice(rounds_ids),IdAction = random.choice(actions_ids)))
session.add_all(round_act)
session.commit()
...
for x in range(10000):
    treasure_ques.append(TreasureQuest(IdQuest = random.choice(quests_ids),IdTreasure = random.choice(treasueres_ids)))
...
treasure_fiel = []
for x in range(10000):
    treasure_fiel.append(TreasureField(IdField = random.choice(fields_ids),IdTreasure = random.choice(treasueres_ids)))
...
roll_skill = []
for x in range(10000):
    roll_skill.append(RollSkill(IdRoll = random.choice(rolls_ids),IdSkill = random.choice(skills_ids)))
...
eq_mod = []
for x in range(10000):
    eq_mod.append(EquipmentModifer(IdMod = random.choice(mod_ids),IdEquipm=random.choice(equips_ids)))
...
eq_char = []
for x in range(10000):
    eq_char.append(CharacterEquipment(IdCharacter = random.choice(characters_ids),IdEquipm= random.choice(equips_ids), Amount= randint(0,3)))
...
eq_tres = []
for x in range(10000):
    eq_tres.append(TreasureEquipment(IdTreasure = random.choice(treasueres_ids),IdEquipm= random.choice(equips_ids)))
...
spec_skill = []
for x in range(30000):
    spec_skill.append(SpecializationSkill(IdSpec = random.choice(specs_ids),IdSkill= random.choice(skills_ids)))
...
char_zone = []
for x in range(1000):
    char_zone.append(CharacterZone(IdCharacter = random.choice(characters_ids),IdZone = random.choice(zones_ids), IdEquipm =  random.choice(equips_ids)))
...
equ_zone = []
for x in range(1000):
    equ_zone.append(EquipmentZone(IdEquipm=   random.choice(equips_ids), IdZone = random.choice(zones_ids)))
    print(x)
